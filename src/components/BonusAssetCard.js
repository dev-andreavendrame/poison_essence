                    ...
                    <Collapse in={expanded} timeout="auto" sx={{ maxWidth: 185 }}>
                        <Box sx={{ backgroundColor: '#551b8c', borderRadius: 2}}>
                            <Typography variant='body2' sx={{ fontSize: 11, color: "white", p: 1 }}>
                                "Hidden in the tangles of the trees and bushes, the scientists discovered a big species of snake: these reptiles live in places where the density of Poison Essence is higher. Spreading the Poison Essence on a tree's bark can sometimes attract the Toxic Snake, but be careful: its bite can be extremely painful!"
                            </Typography>
                        </Box>
                    </Collapse>
                </Box>
